...
JLVALUE * jl_stmt_lst(JLVALUE *, JLNode *);
JLVALUE * jl_obj(JLVALUE *, JLNode *);
JLVALUE * jl_arr(JLVALUE *, JLNode *);
JLVALUE * jl_call(JLVALUE *, JLNode *);
JLVALUE * jl_function_call(JLVALUE *, JLVALUE *, JLNode *);
JLVALUE * jl_setup_func_env(JLVALUE *, JLVALUE *, JLARGS *);
...
JLVALUE * jl_and(JLVALUE *, JLNode *, JLNode *);
JLVALUE * jl_or(JLVALUE *, JLNode *, JLNode *);
