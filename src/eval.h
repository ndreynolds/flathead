...
JSValue * fh_new_exp(JSValue *, Node *);
...
JSValue * fh_function_call(JSValue *, JSValue *, State *, JSValue *, JSArgs *);
JSValue * fh_setup_func_env(JSValue *, JSValue *, JSValue *, JSArgs *);
JSValue * fh_str_from_node(JSValue *, Node *);
JSValue * fh_member(JSValue *, Node *);
JSValue * fh_postfix_exp(JSValue *, Node *);
JSValue * fh_prefix_exp(JSValue *, Node *);
JSValue * fh_bin_exp(JSValue *, Node *);
